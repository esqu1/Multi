...
Let the plane be tangent at $P_0(x_0,y_0,z_0)$, and $\la A,B,C \ra$ be a normal to the plane. Let $P(x,y,z)$ be an arbitrary point in the plane. Then $\overrightarrow{P_0P} = \la x-x_0, y-y_0, z-z_0 \ra$
