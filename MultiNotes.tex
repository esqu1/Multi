...
\begin{tikzpicture}[scale=0.9]
  \begin{axis}[
      ...
      xmin=0,ymin=0,xmax=10,ymax=10,
        ...
        coordinates {(4,2)(5,2.3)(7,3)(6,5)(5.5,5.5)(4,4.5)(2.5,3)(3,2.1)(4,2)}
        [arrow inside={end=stealth,opt={blue,scale=1.5}}{0.25,0.8}];
        \addplot[color=white,smooth,fill=white] coordinates {(5.3,3.7)(4.3,4)(5.3,4.3)(6.3,4)(5.3,3.7)};
        \addplot[blue,smooth] coordinates {(5.3,3.7)(4.3,4)(5.3,4.3)(6.3,4)(5.3,3.7)}
                [arrow inside={end=stealth,opt={blue,scale=1.5}}{0.15}];
  \end{axis}
\end{tikzpicture}
\end{center}
